...
Validation date: **8 September 2026**. Candidate: **0.1.0 (2)**, local beta. Live checks ran on **macOS 26, Apple Silicon (arm64), with Google Chrome** during development of this candidate. Package checks below apply to the final build 2 archive. This record describes observed behavior on that setup; the unverified cases below remain release work.
...
- The app reports version **0.1.0**, build **2**, a macOS 13 minimum, and English/Russian localizations.
